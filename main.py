...
def T5Trainer(
    ...
    if args.img_type is not None:
        ...
        num_model = get_parameter_number(model)
    ...
    # metric = load_metric("models/rouge/rouge.py")
    # metric = load("rouge")
    metric = load_metric("models/rouge/rouge1.py")
...
class MCCoTTrainer(Seq2SeqTrainer):
    ...
    def predict_in_batches(self, test_dataset, max_length, output_json_path, batch_size=16, tokenizer=None, args=None,test_qids=None):
        ...
        for batch_idx, batch in enumerate(dataloader):
            ...
            input_ids_masked = batch['input_ids_masked'].to(self.args.device)
            ...
            with torch.no_grad():
                ...
                outputs = self.model(input_ids=input_ids, input_ids_masked=input_ids_masked, image_ids=image_ids, attention_mask=attention_mask, labels=labels)
